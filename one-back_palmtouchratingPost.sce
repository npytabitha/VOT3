...
Druecke die 'Enter' Taste um Deine Auswahl zu bestaetigen."; font_size = 20; text_align = align_center; width=50; } textScaleLabelCenter;
        x = 0; y = -330;
    text { caption = "0"; font_size = 36; font_color = 255, 0, 0; } textRating;
        x = 0; y = -130;
        text { 
caption = "Wie angenehm (+2) oder unangehem (-2) war die Beruehrung?"; 
font = "Arial";
...
sub
    int get_rating1( int starting_val )
begin
